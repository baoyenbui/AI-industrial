from sqlalchemy import Column, Integer, String, Float, Text, DateTime, JSON, Index, Boolean
from sqlalchemy.sql import func
import uuid
from ..core.database_knowledge import Base
...
class MedicalKnowledge(Base):
    ...
    drug_compatibility = Column(JSON)
    ...
    __table_args__ = (
        ...
        Index("ix_disease_drug", "disease_name", "drug_name"),
    )
